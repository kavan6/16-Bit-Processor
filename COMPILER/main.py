...
from parser import _ast as AST
...
from allocator import _allocator as allocator
...
r0 = allocator.RegisterAllocator(None, g0.output)

print(r0.get_instructions())

a0 = assembler.Assembler(r0.get_instructions())
